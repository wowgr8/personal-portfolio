    ...
    <div className='experience'>
      <VerticalTimeline lineColor="#3e497a">
        <VerticalTimelineElement className="vertical-timeline-element--work" date="02/2019 - 04/2020" iconStyle={{ background: "#e9d35b", color: "#fff" }} icon={<GiSuitcase />}>
          ...
          <p> 
            Meticulously reviewed photo deposits as well as searched for and identified suspicious deposit-to-withdrawal patterns as part of the Deposit Risk team, Supported account holders and applicants via phone and message channels with empathy and high attention to detail, Expertise in balancing multiple streams of work across various platforms including Belvedere, Jira, Confluence, and SalesForce.
          </p>
